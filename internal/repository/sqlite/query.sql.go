...
func (q *Queries) DeleteExpiredSessions(ctx context.Context, refreshExpiresAt time.Time) error {
	_, err := q.db.ExecContext(ctx, deleteExpiredSessions, refreshExpiresAt)
	return err
}
